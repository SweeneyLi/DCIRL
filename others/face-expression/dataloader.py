...
class Expression_Dataset(data.Dataset):
  ...
  def __getitem__(self, idx):
    ...
    return sample, image_expression_label


class Age_Dataset(data.Dataset):
  def __init__(self, opt):
  ...
  def __getitem__(self, idx):
    ...
    return sample, image_age_label

class Gender_Dataset(data.Dataset):
  def __init__(self, opt):
  ...
  def __getitem__(self, idx):
    ...
    # image_age_label = torch.from_numpy(np.array(image_age_label).astype(np.long))
    #label=[image_expression_label,image_gender_label,image_age_label]
    return sample,image_gender_label
